    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
       return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/","/hash","/home","/login", "/register", "/profile","/add-recipe","/recipe-details","edit-recipe").permitAll() // Tillåt åtkomst till startsida och registreringssida utan inloggning
